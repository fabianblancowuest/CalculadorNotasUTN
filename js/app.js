...
function calcularNota() {
	const erroresVF = obtenerErrores("erroresVF", configuracion.vf.maxErrores);
	...
	document.getElementById("puntaje").textContent = mostrarNumero(puntajeExacto);
	...
	document.getElementById("dDescVF").textContent = mostrarNumero(vf.descuento);
	document.getElementById("dPuntosVF").textContent = mostrarNumero(vf.puntaje);

	document.getElementById("dErroresMultiple").textContent = erroresMultiple;
	...
	document.getElementById("dErroresCompletar").textContent = erroresCompletar;
